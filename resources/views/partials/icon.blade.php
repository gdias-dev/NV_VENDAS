@php
    $icons = [
        ...
        'split'     => '<circle cx="12" cy="12" r="9"/><path d="M3 12h18"/>',
        'sparkle'   => '<path d="M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3Z"/><path d="M19 16v4M17 18h4"/>',
...
@endphp
<svg class="{{ $class ?? 'h-6 w-6' }}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">{!! $icons[$icon] ?? '' !!}</svg>
